...
import {
  ...
  DEFAULT_ASSIGNED_LEVEL_LIMITS,
  DEFAULT_DIMENSION_OVERVIEW_INSTRUCTIONS,
  DEFAULT_DIM_OVERVIEW_LIMITS,
  DEFAULT_SUB_EVAL_LIMITS,
  DEFAULT_SUBDIMENSION_EVAL_INSTRUCTIONS,
  DEFAULT_TRL_EVAL_INSTRUCTIONS,
  DEFAULT_TRL_EVAL_LIMITS,
  DEFAULT_VARIABLE_EVAL_INSTRUCTIONS,
  TRL_EVAL_ID,
  TRL_LEVEL_ID,
  defaultInstructionForSectionKind,
  dimensionOverviewId,
  newReportSectionId,
  subdimensionEvalId,
  variableEvalId,
...
const DEFAULT_DIM_OVERVIEW = DEFAULT_DIM_OVERVIEW_LIMITS;
const DEFAULT_SUB_EVAL = DEFAULT_SUB_EVAL_LIMITS;
const DEFAULT_ASSIGNED_LEVEL = DEFAULT_ASSIGNED_LEVEL_LIMITS;
const DEFAULT_TRL_EVAL = DEFAULT_TRL_EVAL_LIMITS;
