      ...
      <div className="flex shrink-0 items-center justify-between gap-2 border-b border-border px-4 py-3">
        ...
        <div className="flex shrink-0 items-center gap-1">
          ...
          <button
            ...
            className="rounded px-3 py-1.5 text-sm font-medium text-foreground-muted hover:bg-surface-elevated focus:outline-none focus:ring-2 focus:ring-focus-ring"
          >
            Exportar PDF
          </button>
        </div>
